...
public class Sabot_detailsListActivity extends BaseActivity implements View.OnClickListener {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_sabot_details_list);
    ...
    public void initView() {
        ...
        scanImgBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent it = new Intent(Sabot_detailsListActivity.this, CaptureActivity.class);
        ...
        this.allbagnumTxtView=(TextView)findViewById(R.id.allbagnums);
        this.allrollnumTxtView=(TextView)findViewById(R.id.allrollnums);
        this.alltraynumTxtView=(TextView)findViewById(R.id.alltraynums);
        ...
        barcodeExtText.addTextChangedListener(new TextWatcher() {
            ...
            public void afterTextChanged(Editable e) {
                ...
                if (content.length() > 0) {
                    ArrayList<dacdiaobodan1> fileterList = (ArrayList<dacdiaobodan1>) search(content);
                    mordergoodListAdapter.updateListView(fileterList);
                    //mAdapter.updateData(mContacts);
                } else {
                    mordergoodListAdapter.updateListView(orderdetailslist);
                    for (dacdiaobodan1 contact : orderdetailslist) {
                ...
                allbagnumTxtView.setText(df.format(sumnum));
                allrollnumTxtView.setText(df.format(summny));
                alltraynumTxtView.setText(df.format(summny));
            }
        ...
        this.mListView.setOnItemLongClickListener(new AdapterView.OnItemLongClickListener() {
            ...
            public boolean onItemLongClick(AdapterView<?> parent, View view,
                ...
                final dacdiaobodan1 rukuInfo = orderdetailslist.get(position);
                if(rukuInfo==null || rukuInfo.itemNo=="" || rukuInfo.itemNo=="0"){
                    UIUtil.showToast("提示：请选择盘点信息");
                    return false;
                }
                else {
                    AlertDialog.Builder builder = new AlertDialog.Builder(Sabot_detailsListActivity.this);
                    builder.setMessage("商品名称【" + rukuInfo.goodsName + "】确定删除?");
                    builder.setTitle("提示");
                    ...
                    builder.setPositiveButton("确定", new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            AppService.getInstance().deletediaobodan1bodyAsync(rukuInfo.billId.toString(), rukuInfo.itemNo, currentuser.userid, clientid, new JsonCallback<LslResponse<Object>>() {
                                @Override
    ...
    public void loaddata() {
        ...
        mordergoodListAdapter=new GoodsDetailsDacdiaoboListAdapter(Sabot_detailsListActivity.this,orderdetailslist);
    ...
    private TextView alltraynumTxtView;
    private TextView allbagnumTxtView;
    private TextView allrollnumTxtView;
