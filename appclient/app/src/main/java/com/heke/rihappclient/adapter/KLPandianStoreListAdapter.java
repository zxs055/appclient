...
public class KLPandianStoreListAdapter extends BaseAdapter {
    private Context context;
    private List<KL_outstore_model> list;

    public KLPandianStoreListAdapter(Context paramContext, List<KL_outstore_model> paramList)
    {
    ...
    {
        KLPandianStoreListAdapter.ViewHolder localViewHolder=null;
        if (null == paramView)
        {
            localViewHolder = new KLPandianStoreListAdapter.ViewHolder();
            LayoutInflater mInflater = LayoutInflater.from(context);
            paramView = mInflater.inflate(R.layout.item_kl_pandianstore_list, null);
        ...
        {
            localViewHolder = (KLPandianStoreListAdapter.ViewHolder) paramView.getTag();
        }
