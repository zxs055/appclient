...
public class OutStoreListActivity extends BaseActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_outstore_list);
    ...
    private void loadbilllist() {
        ...
        AppService.getInstance().getfahuobilllistAsync( token,clientid, new JsonCallback<LslResponse<List<KL_outstore_model>>>() {
            @Override
            public void onSuccess(LslResponse<List<KL_outstore_model>> listLslResponse, Call call, Response response) {
                ...
                if (listLslResponse.code == LslResponse.RESPONSE_ERROR) {
                    ...
                    if(listLslResponse.data!=null) {
                        billListAdapter=new KLOutStoreListAdapter(OutStoreListActivity.this,billlist);
    ...
    public void initView() {
        ...
        this.mListView.setOnItemClickListener(new AdapterView.OnItemClickListener()
        {
            ...
            {
                String seltxt=OutStoreListActivity.this.selectEtxt.getText().toString();
                ...
                if(outstoremodel==null || outstoremodel.ID ==""){
                    ...
                    OutStoreListActivity.this.billid=outstoremodel.ID;
                    OutStoreListActivity.this.billcode=outstoremodel.BillNo;
                    OutStoreListActivity.this.name=outstoremodel.Name;
                    OutStoreListActivity.this.JEmpName=outstoremodel.JEmpName;
                    Intent newInt=new Intent(OutStoreListActivity.this,OutStoreIndexActivity.class);
                    Bundle loaclBundle=new Bundle();
                    loaclBundle.putString("billid",OutStoreListActivity.this.billid);
                    loaclBundle.putString("billcode",OutStoreListActivity.this.billcode);
                    loaclBundle.putString("name",OutStoreListActivity.this.name);
                    loaclBundle.putString("JEmpName",OutStoreListActivity.this.JEmpName);
                    newInt.putExtras(loaclBundle);
                    OutStoreListActivity.this.startActivityForResult(newInt,100);
                }
            }
        });
        ...
        scanImgBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent it = new Intent(OutStoreListActivity.this, CaptureActivity.class);
