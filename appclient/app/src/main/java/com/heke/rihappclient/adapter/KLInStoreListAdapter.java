...
public class KLInStoreListAdapter extends BaseAdapter {
    private Context context;
    private List<KL_outstore_model> list;

    public KLInStoreListAdapter(Context paramContext, List<KL_outstore_model> paramList)
    {
    ...
    {
        KLInStoreListAdapter.ViewHolder localViewHolder=null;
        if (null == paramView)
        {
            localViewHolder = new KLInStoreListAdapter.ViewHolder();
            LayoutInflater mInflater = LayoutInflater.from(context);
            paramView = mInflater.inflate(R.layout.item_kl_instore_list, null);
        ...
        {
            localViewHolder = (KLInStoreListAdapter.ViewHolder) paramView.getTag();
        }
