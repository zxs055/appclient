...
public class CgOrderApplyListAdapter extends BaseAdapter {
        private Context context;
        private List<dacdiaobodan1> list;

        public CgOrderApplyListAdapter(Context paramContext, List<dacdiaobodan1> paramList)
        {
        ...
        public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
        {
            ...
            if (null == paramView)
            {
                ...
                paramView = mInflater.inflate(R.layout.item_listview3, null);
                ...
                localViewHolder.tv_diaobonumb=(TextView)paramView.findViewById(R.id.tv_diaobonumber);
            ...
            if (null != markerItem)
            {
                ...
                localViewHolder.tv_diaobonumb.setText(markerItem.totalQuantity);
