...
public class InStoreListActivity extends BaseActivity implements View.OnClickListener {
    ...
    private void loadbilllist() {
        ...
        AppService.getInstance().getdaohuobilllistAsync( token,clientid, new JsonCallback<LslResponse<List<KL_outstore_model>>>() {
            @Override
            public void onSuccess(LslResponse<List<KL_outstore_model>> listLslResponse, Call call, Response response) {
                ...
                if (listLslResponse.code == LslResponse.RESPONSE_ERROR) {
                    ...
                    if(listLslResponse.data!=null) {
                        billListAdapter=new KLInStoreListAdapter(InStoreListActivity.this,billlist);
    ...
    public void initView() {
        ...
        this.mListView.setOnItemClickListener(new AdapterView.OnItemClickListener()
        {
            ...
            {
                String seltxt=InStoreListActivity.this.selectEtxt.getText().toString();
                ...
                if(outstoremodel==null || outstoremodel.ID ==""){
                    ...
                    InStoreListActivity.this.billid=outstoremodel.ID;
                    InStoreListActivity.this.billcode=outstoremodel.BillNo;
                    InStoreListActivity.this.name=outstoremodel.Name;
                    InStoreListActivity.this.JEmpName=outstoremodel.JEmpName;
                    Intent newInt=new Intent(InStoreListActivity.this,InStoreIndexActivity.class);
                    Bundle loaclBundle=new Bundle();
                    loaclBundle.putString("billid",InStoreListActivity.this.billid);
                    loaclBundle.putString("billcode",InStoreListActivity.this.billcode);
                    loaclBundle.putString("name",InStoreListActivity.this.name);
                    loaclBundle.putString("JEmpName",InStoreListActivity.this.JEmpName);
                    newInt.putExtras(loaclBundle);
                    InStoreListActivity.this.startActivityForResult(newInt,100);
                }
            }
        });
        ...
        scanImgBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent it = new Intent(InStoreListActivity.this, CaptureActivity.class);
    ...
    private KLInStoreListAdapter billListAdapter;
