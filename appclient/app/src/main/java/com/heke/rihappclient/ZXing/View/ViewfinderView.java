...
//            paint.setAlpha(SCANNER_ALPHA[scannerAlpha]);
            ...
            paint.setShader(new RadialGradient((frame.left + frame.right) / 2, middle + 7, frame.width() / 2, laserColor, laserColor & 0x00FFFFFF, TileMode.MIRROR));
//            canvas.drawRect(frame.left + 2, middle - 1, frame.right - 1,
//                    middle + 2, paint);
            RectF lineRect = new RectF(frame.left, middle, frame.right, middle + 15);
            canvas.drawRoundRect(lineRect, 50, 5, paint);
            paint.setColor(Color.WHITE);
            paint.setShader(new RadialGradient((frame.left + frame.right) / 2, middle + 7, frame.width() / 2, Color.WHITE, Color.WHITE & 0x00FFFFFF, TileMode.MIRROR));
