...
public class TaskListAdapter extends BaseAdapter {
    ...
    public TaskListAdapter(Context paramContext, List<dacdiaobodan1> paramList)
    {
    ...
    {
        TaskListAdapter.ViewHolder localViewHolder=null;
        if (null == paramView)
        {
            localViewHolder = new TaskListAdapter.ViewHolder();
            LayoutInflater mInflater = LayoutInflater.from(context);
            paramView = mInflater.inflate(R.layout.item_kl_task_list_details, null);
        ...
        {
            localViewHolder = (TaskListAdapter.ViewHolder) paramView.getTag();
        }
