...
public class PandianDetailActivity extends BaseActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pandian_details);
    ...
    public void init() {
        ...
        this.kuweiname=localIntent.getStringExtra("kuweiname");
        this.billcodeTxt.setText(billcode);
        this.storenameTxt.setText(storename+"/"+kuweiname);
    ...
    public void initView() {
        ...
        scanImgBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent it = new Intent(PandianDetailActivity.this, CaptureActivity.class);
