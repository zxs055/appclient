...
import com.heke.rihappclient.utils.DisplayMetricsUtil;
...
public class TitleView extends FrameLayout {
    ...
    public void setLeftButtonAsFinishWhite(final Activity a) {
        showView(0, 0);
        mLeftText.setText("\ue60c");
        mLeftText.setTextColor(ContextCompat.getColor(a, R.color.white1));
        setLeftButtonOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                a.finish();
    ...
    protected void onFinishInflate() {
        ...
        mLeftText.setTextColor(ContextCompat.getColor(mContext, R.color.white1));
        ...
        mCenterText.setTextColor(ContextCompat.getColor(mContext,R.color.white1));
        ...
        mRightText.setTextColor(ContextCompat.getColor(mContext,R.color.white1));
